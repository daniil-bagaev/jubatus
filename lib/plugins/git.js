...
const 
    ...
    gitter = {
        ...
        git (opts) {
            ...
            let 
                status = gitter.exec('git status -b --ignored=matching').toString(),
                add = gitter.exec('git add .').toString(),
                commit =  gitter.exec('git commit -m"'+opts.message+'"').toString(),
                push = gitter.exec('git push -u origin main').toString();
            log(status);
