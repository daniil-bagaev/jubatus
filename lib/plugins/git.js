const 
    ...
    gitter = {
        ...
        git (opts) {
            ...
            log(status, {filename: 'gitter.log', header: '[Git status]', date: 'DD/MM/YYYY HH:mm:ss'});
            log(add, {filename: 'gitter.log', header: '[Git add]', date: 'DD/MM/YYYY HH:mm:ss'});
            log(commit, {filename: 'gitter.log', header: '[Git commit]', date: 'DD/MM/YYYY HH:mm:ss'});
            log(push, {filename: 'gitter.log', header: '[Git push]', date: 'DD/MM/YYYY HH:mm:ss'});
        }
    };
